...
var readMT = function (el, name) {
    var prop = el.getAttribute("name") || el.getAttribute("property");
    return prop == name ? el.getAttribute("content") : null;
};
var parse = function (url, config) { return __awaiter(void 0, void 0, void 0, function () {
    var data, $, og, meta, images, title, canonical, metas, _loop_1, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!/(^http(s?):\/\/[^\s$.?#].[^\s]*)/i.test(url))
                    return [2, {}];
                return [4, axios(url, config)];
            case 1:
                data = (_a.sent()).data;
                $ = HTML(data);
                og = {}, meta = {}, images = [];
                ...
                canonical = $.querySelector("link[rel=canonical]");
                if (canonical) {
                ...
                return [2, { meta: meta, og: og, images: images }];
        }
    });
}); };
var parser = parse;
